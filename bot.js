...
m.sendMessage(args)
 ...
 client.on('message' , function (message){
      var token = 'NTMzNjczNTMzMTgwNjA4NTUy.DxueIw._vRxv20NlbvCOrJMT7oo9w-iTm0'; // التوكن هنا بس
...
client.login("NTMzNjczNTMzMTgwNjA4NTUy.DxueIw._vRxv20NlbvCOrJMT7oo9w-iTm0"); 